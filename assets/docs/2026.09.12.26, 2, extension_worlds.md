...
> Current wiring (worker injects only the isolated bridge; the bridge / DevTools put the client in MAIN): [2026.09.14.26, 2, main_isolated_worlds.md](./2026.09.14.26,%202,%20main_isolated_worlds.md).
