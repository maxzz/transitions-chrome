...
import { recordCssAnimation } from "./1-1-plugin-css-animation";
import { recordCssTransition } from "./1-2-plugin-css-transition";
import { isAnimationRecorded, markAnimationRecorded } from "./2-utils-recorded-animations";
