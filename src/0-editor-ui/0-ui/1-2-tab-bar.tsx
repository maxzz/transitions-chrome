...
function RecordButton({ isRecording, startRecording, stopRecording }: { isRecording: boolean; startRecording: () => void; stopRecording: () => void; }) {
    ...
    return (<>
        ...
        <motion.button
            ...
            type="button"
        >
            <RecordIcon variants={{ pressed: { scale: 0.8 } }} style={{ backgroundColor: isRecording ? "var(--red)" : "rgba(255,255,255,0.5)" }} />
